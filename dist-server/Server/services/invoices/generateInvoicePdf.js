...
function drawFromSection(doc, data) {
    const startY = 130;
    doc
        .font(FONTS.bold)
        .fontSize(11)
...
function drawBillToSection(doc, data) {
    const startY = 130;
    const rightX = 300;
    doc
        .font(FONTS.bold)
...
function drawLineItemsTable(doc, data) {
    const startY = 250;
    ...
    doc._invoiceTableEndY = rowY;
}
function drawTotalSection(doc, data) {
    const tableEndY = doc._invoiceTableEndY || 350;
    ...
    doc._invoiceTotalEndY = totalY + 45;
}
function drawBankingSection(doc, data) {
    const startY = doc._invoiceTotalEndY || 400;
