...
export function SubmitHoursModal({ open, onOpenChange }: SubmitHoursModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[640px] max-h-[90vh] overflow-y-auto bg-white p-0" aria-describedby="submit-hours-description">
        <DialogHeader className="px-6 pt-6 pb-4 border-b border-gray-200">
          <DialogTitle className="text-xl font-semibold text-gray-900">
            Submit Hours
          </DialogTitle>
          <DialogDescription id="submit-hours-description" className="sr-only">
          ...
          {selectedMonth !== null && calendarDays.length > 0 && (
            <div className="space-y-4 pt-2">
              ...
              <div className="bg-[#EEF3FF] border border-blue-200 rounded-[10px] p-4 flex gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm text-blue-900 leading-relaxed">
                    ...
                    <br />
                    Click on highlighted days to exclude them from calculation.
                  </p>
                </div>
              </div>
                        ...
                        className={`
                          ...
                          ${
                            dayInfo.state === "working"
                              ...
                              : dayInfo.state === "excluded"
                              ? "bg-white border-2 border-dashed border-red-400 text-red-600 hover:bg-red-50 cursor-pointer"
              ...
              <div className="flex items-center justify-center gap-6 text-xs text-gray-600">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-4 h-4 rounded bg-white border-2 border-dashed border-red-400" />
