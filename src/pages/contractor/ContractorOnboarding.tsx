...
export function ContractorOnboarding() {
  ...
  // New Step navigation
  const [step, setStep] = React.useState<"welcome" | "upload" | "review" | "payment">(
    "welcome",
  );

  // Banking state (for new users)
      ...
      if (invoiceFile) {
        ...
        if (invPath && onboardingType === "migrating") {
          ...
          if (extractResult.ok && extractResult.data) {
            ...
            if (ext.routingNumber) patch.bank_routing_number = ext.routingNumber;
  ...
  const handleConfirmAndFinish = async () => {
    ...
    try {
      const finalPatch = {
        ...
        onboarding_rate:
          rate !== "" ? Number(rate) : uploadedPatch.onboarding_rate,
        ...
        bank_name: bankName || uploadedPatch?.bank_name,
        bank_address: bankAddress || uploadedPatch?.bank_address,
        swift_code: swiftCode || uploadedPatch?.swift_code,
        bank_routing_number: routingNumber || uploadedPatch?.bank_routing_number,
        account_type: accountType || uploadedPatch?.account_type,
        currency: currency || uploadedPatch?.currency,
        bank_account_number: accountNumber || uploadedPatch?.bank_account_number,
      };
          ...
          <div className="max-w-[850px] w-full bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-10 md:p-12 text-center mt-6 mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12 text-left">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-[#1A61D5] mb-3">
    ...
    return (
      <div className="w-full flex items-center justify-center gap-4 mb-10 max-w-lg mx-auto">
        <div className="flex flex-col items-center">
          ...
          <span
            className={`text-xs mt-1.5 font-medium ${isWelcomeActive ? "text-blue-600 font-semibold" : "text-gray-500"}`}
          >
            Welcome
          </span>
          <span className={`text-[10px] text-gray-400 mt-0.5`}>
            {isWelcomeDone ? "Completed" : "In Progress"}
          </span>
        </div>

        <div
          className={`flex-1 h-0.5 -mt-6 transition-colors ${isWelcomeDone ? "bg-green-500" : "bg-gray-200"}`}
        />
        ...
        <div className="flex flex-col items-center">
          ...
          <span
            className={`text-xs mt-1.5 font-medium ${isUploadActive ? "text-blue-600 font-semibold" : "text-gray-500"}`}
          >
            Upload Documents
          </span>
          <span className={`text-[10px] text-gray-400 mt-0.5`}>
    ...
    return (
      <div className="border border-gray-200 rounded-xl p-6 flex flex-col md:flex-row items-center justify-between gap-6 bg-white">
        <div className="flex items-center gap-4 w-full md:w-auto">
          <div
            className={`w-12 h-12 rounded-full flex items-center justify-center shrink-0 ${isW8 ? "bg-[#EAF7ED] text-[#2E7D32]" : isInv ? "bg-[#FFF4E5] text-[#B76E00]" : "bg-[#EBF3FF] text-[#1A61D5]"}`}
          >
        ...
        <div className="max-w-[850px] w-full bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 md:p-12 text-center mt-6 mb-8">
          ...
          {step === "upload" && (
            <div>
              ...
              <p className="text-gray-600 mb-10 max-w-lg mx-auto text-[15px] leading-relaxed">
                ...
                We'll automatically extract your contract information to speed
                up setup.
              </p>
              ...
              <div className="space-y-6 text-left">
                ...
                <div className="border border-blue-100 bg-[#F5F8FF] rounded-xl p-4 flex gap-3 text-sm text-blue-800 items-start mt-6">
                  ...
                  <span>
                    After all documents are uploaded, we'll automatically
                    extract your role, contract rate, contract dates, and other
                    details for review.
                  </span>
                </div>
              </div>
          ...
          {step === "review" && (
            <div>
              ...
              <p className="text-gray-600 mb-10 max-w-lg mx-auto text-[15px] leading-relaxed">
                We've extracted the information from your documents. Please
                review and confirm that everything is correct before you
                continue.
              </p>
              ...
              <div className="space-y-6 text-left">
                    ...
                    {workOrderFile && (
                      <div className="flex items-center justify-between border border-gray-100 rounded-xl p-4 bg-[#F8FAFC]">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-sm font-semibold text-gray-900 truncate max-w-[200px] md:max-w-[300px]">
                              {workOrderFile.name}
                            </p>
                            <p className="text-xs text-gray-500 mt-0.5">
                              {(workOrderFile.size / (1024 * 1024)).toFixed(1)}{" "}
                              MB • PDF
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="flex items-center justify-between border border-gray-100 rounded-xl p-4 bg-[#F8FAFC]">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-500 mt-0.5">
                              {(w8BenFile.size / (1024 * 1024)).toFixed(1)} MB •
                              PDF
                            </p>
                          </div>
                        </div>
                ...
                <div className="border border-blue-100 bg-[#F5F8FF] rounded-xl p-4 flex gap-3 text-sm text-blue-800 items-start">
                  ...
                  <span>
                    Your information is secure and will only be used for invoice
                    processing and payments. You can update your information
          ...
          {step === "payment" && (
            <div>
              ...
              <p className="text-gray-600 mb-10 max-w-lg mx-auto text-[15px] leading-relaxed">
                Please provide your banking information so we can process your invoice payments securely.
              </p>
                ...
                <div className="border border-gray-200 rounded-xl p-6 bg-white shadow-sm">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="md:col-span-2">
                      <Label className="text-sm font-semibold text-gray-900">Name of Bank <span className="text-red-500">*</span></Label>
                      <Input value={bankName} onChange={e => setBankName(e.target.value)} className="mt-2" placeholder="e.g. Chase Bank" />
                    </div>
                    <div className="md:col-span-2">
                      <Label className="text-sm font-semibold text-gray-900">Bank Address <span className="text-red-500">*</span></Label>
                      <Input value={bankAddress} onChange={e => setBankAddress(e.target.value)} className="mt-2" />
                    </div>
                    <div>
                      <Label className="text-sm font-semibold text-gray-900">SWIFT Code <span className="text-red-500">*</span></Label>
                      <Input value={swiftCode} onChange={e => setSwiftCode(e.target.value)} className="mt-2" />
                    </div>
                    <div>
                      <Label className="text-sm font-semibold text-gray-900">ABA / Wire Routing <span className="text-red-500">*</span></Label>
                      <Input value={routingNumber} onChange={e => setRoutingNumber(e.target.value)} className="mt-2" />
                    </div>
                    <div>
                      <Label className="text-sm font-semibold text-gray-900">Account Type <span className="text-red-500">*</span></Label>
                      <select
                        value={accountType}
                    ...
                    <div>
                      <Label className="text-sm font-semibold text-gray-900">Currency <span className="text-red-500">*</span></Label>
                      <select
                        value={currency}
                    ...
                    <div className="md:col-span-2">
                      <Label className="text-sm font-semibold text-gray-900">Account Number <span className="text-red-500">*</span></Label>
