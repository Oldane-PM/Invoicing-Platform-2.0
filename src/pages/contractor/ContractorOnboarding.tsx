...
export function ContractorOnboarding() {
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center">
          <h1 className="text-2xl font-semibold text-gray-900 mb-2">
            Welcome to Invoicing Platform
          </h1>
          <p className="text-gray-600 mb-8">
            To get started, tell us a bit about your status.
          </p>
          ...
          <div className="space-y-4">
            ...
            >
              <CheckCircle2 className="w-5 h-5 mr-3 text-gray-400" />I am a New
              Contractor
            </Button>
            <Button
              variant="outline"
            ...
            >
              <CheckCircle2 className="w-5 h-5 mr-3 text-gray-400" />I am an
              existing Contractor
            </Button>
          </div>
        </div>
  ...
  const DocumentUploadRow = ({
    ...
    return (
      <div
        className={`p-4 rounded-xl border flex flex-col sm:flex-row sm:items-center justify-between gap-4 transition-colors ${file ? "bg-blue-50/50 border-blue-200" : "bg-white border-gray-200 hover:border-gray-300"}`}
      >
        <div className="flex items-center gap-4">
          <div
            className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 ${file ? "bg-blue-100" : "bg-gray-100"}`}
          >
            {file ? (
          ...
          <div className="min-w-0">
            <h3
              className={`text-sm font-medium ${file ? "text-blue-900" : "text-gray-900"}`}
            >
              {title}
            </h3>
        ...
        <div className="flex-shrink-0">
          {file ? (
            <Button
              ...
              className="text-gray-500 hover:text-red-600 hover:bg-red-50 w-full sm:w-auto"
            >
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center py-12 px-4">
      <div className="max-w-2xl w-full bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8">
        ...
        <p className="text-gray-600 mb-8">
          Please upload the required documents below to finish setting up your
          account.
        </p>
        ...
        <div className="space-y-6">
          ...
          <div className="pt-8 mt-8 border-t border-gray-100 flex flex-col-reverse sm:flex-row justify-end gap-3">
            ...
            <Button
              ...
              disabled={isSubmitting}
              className="h-11 px-8 sm:w-auto w-full bg-blue-600 hover:bg-blue-700 text-white font-medium shadow-sm"
            >
              {isSubmitting ? (
