...
export function SubmissionReviewDrawer({
  ...
  const getStatusLabel = (status: string) => {
    // Map DB status to frontend label
  ...
  // Submission is resolved if paid or rejected
  const isPaid = !!(submission?.status === "approved" && submission?.paidAt);
            ...
            {isLoading ? (
              ...
              <>
                ...
                {submission.paymentLink && (
                  <div className="space-y-4 mb-6">
                    <h3 className="text-sm font-semibold text-gray-900">Payment Info</h3>
                    <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                      {submission.paymentLink.startsWith('http') ? (
                        <a 
                        ...
                        <div className="text-sm text-gray-900 break-all leading-relaxed">
                          {submission.paymentLink}
                        </div>
                      )}
                    </div>
                ...
                {/* Manager Response (if manager responded to clarification) */}
                {submission.managerNote && (
                  <div className="space-y-4 mb-6">
                    <h3 className="text-sm font-semibold text-gray-900">Manager Response</h3>
                    <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                      <p className="text-sm text-blue-700">{submission.managerNote}</p>
                    </div>
                  </div>
                )}
          ...
          {submission && (
            <div className="px-6 py-4 border-t border-gray-200 bg-white">
              {isPaid || submission.status === "paid" ? (
                ...
                <div className="text-center py-2">
                  <p className="text-sm text-gray-600">
                    This submission has been rejected and returned to the contractor.
                  </p>
                </div>
              ) : canAdminAct ? (
                ...
                <div className="space-y-2">
                  <Button
                    ...
                    className="w-full bg-purple-600 hover:bg-purple-700 h-10 rounded-lg"
                  ...
                  <Button
                    ...
                    className="w-full h-10 rounded-lg border-yellow-300 text-yellow-700 hover:bg-yellow-50 hover:text-yellow-800 hover:border-yellow-400"
