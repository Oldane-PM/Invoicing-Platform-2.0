...
export function AddContractorDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]" aria-describedby="add-contractor-description">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <UserPlus className="w-5 h-5 text-blue-600" />
            Add Contractor to Team
          </DialogTitle>
          <DialogDescription id="add-contractor-description">
            Search for contractors and add them to your team.
          </DialogDescription>
        </DialogHeader>
